...
// This is option name where all the Redux data is stored.
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Sample Options', 'shadin' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Sample Options', 'shadin' ),
...
$args['admin_bar_links'][] = array(
	'id'    => 'redux-docs',
	'href'  => '//devs.redux.io/',
	'title' => __( 'Documentation', 'shadin' ),
);

$args['admin_bar_links'][] = array(
	'id'    => 'redux-support',
	'href'  => '//github.com/ReduxFramework/redux-framework/issues',
	'title' => __( 'Support', 'shadin' ),
);
...
if ( ! isset( $args['global_variable'] ) || false !== $args['global_variable'] ) {
	...
	$args['intro_text'] = '<p>' . sprintf( esc_html__( 'Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: $%1$s', 'shadin' ), '<strong>' . $v . '</strong>' ) . '<p>';
} else {
	$args['intro_text'] = '<p>' . esc_html__( 'This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.', 'shadin' ) . '</p>';
}

// Add content after the form.
$args['footer_text'] = '<p>' . esc_html__( 'This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.', 'shadin' ) . '</p>';
...
$help_tabs = array(
	array(
		'id'      => 'redux-help-tab-1',
		'title'   => esc_html__( 'Theme Information 1', 'shadin' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'shadin' ) . '</p>',
	),
	array(
		'id'      => 'redux-help-tab-2',
		'title'   => esc_html__( 'Theme Information 2', 'shadin' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'shadin' ) . '</p>',
	),
);
...
$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'shadin' ) . '</p>';
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Basic Fields', 'shadin' ),
		'id'               => 'basic',
		'desc'             => esc_html__( 'These are really basic fields!', 'shadin' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Editors', 'shadin' ),
		'id'               => 'editor',
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Color Selection', 'shadin' ),
		'id'    => 'color',
		'icon'  => 'el el-brush',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Design Fields', 'shadin' ),
		'id'    => 'design',
		'icon'  => 'el el-wrench',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Media Uploads', 'shadin' ),
		'id'    => 'media',
		'icon'  => 'el el-picture',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Presentation Fields', 'shadin' ),
		'id'    => 'presentation',
		'icon'  => 'el el-screen',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Switch / Button Set', 'shadin' ),
		'id'    => 'switch_buttonset',
		'icon'  => 'el el-cogs',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Select Fields', 'shadin' ),
		'id'    => 'select',
		'icon'  => 'el el-list-alt',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Slider / Spinner', 'shadin' ),
		'id'    => 'slider_spinner',
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Additional Types', 'shadin' ),
		'id'    => 'additional',
		'icon'  => 'el el-magic',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Advanced Features', 'shadin' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Disabling', 'shadin' ),
		'icon'  => 'el el-lock',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Redux Extensions', 'shadin' ),
		'id'    => 'redux-extensions',
		'icon'  => 'el el-redux',
		'class' => 'pro_highlight',
		'desc'  => esc_html__( 'For full documentation on this field, visit: ', 'shadin' ) . '<a href="https://devs.redux.io/core-extensions/" target="_blank">https://devs.redux.io/core-extensions/</a>',
	)
);
...
if ( file_exists( $dir . '/../README.md' ) ) {
	$section = array(
		'icon'   => 'el el-list-alt',
		'title'  => esc_html__( 'Documentation', 'shadin' ),
		'fields' => array(
			array(
...
Redux::set_section(
	...
	array(
		'icon'            => 'el el-list-alt',
		'title'           => esc_html__( 'Customizer Only', 'shadin' ),
		'desc'            => '<p class="description">' . esc_html__( 'This Section should be visible only in Customizer', 'shadin' ) . '</p>',
		'customizer_only' => true,
		'fields'          => array(
			array(
				'id'              => 'opt-customizer-only',
				'type'            => 'select',
				'title'           => esc_html__( 'Customizer Only Option', 'shadin' ),
				'subtitle'        => esc_html__( 'The subtitle is NOT visible in customizer', 'shadin' ),
				'desc'            => esc_html__( 'The field desc is NOT visible in customizer.', 'shadin' ),
				'customizer_only' => true,
				'options'         => array(
					'1' => esc_html__( 'Opt 1', 'shadin' ),
					'2' => esc_html__( 'Opt 2', 'shadin' ),
					'3' => esc_html__( 'Opt 3', 'shadin' ),
				),
				'default'         => '2',
			),
		),
...
if ( ! function_exists( 'dynamic_section' ) ) {
	...
	function dynamic_section( array $sections ): array {
		$sections[] = array(
			'title'  => esc_html__( 'Section via hook', 'shadin' ),
			'desc'   => '<p class="description">' . esc_html__( 'This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.', 'shadin' ) . '</p>',
...
if ( ! function_exists( 'change_defaults' ) ) {
	...
	function change_defaults( array $defaults ): array {
		$defaults['str_replace'] = esc_html__( 'Testing filter hook!', 'shadin' );
